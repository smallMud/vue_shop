...
export const gitGoodlist = (data) => Network.get('goods', data)
export const postGoodlist = (data) => Network.post('goods', data)
export const getOrders = (data) => Network.get('orders', data)
export const getReports = () => Network.get('reports/type/1')
